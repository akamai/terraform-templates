...
module "api_definition" {
  source   = "git::https://github.com/akamai/terraform-templates-modules.git//bmp/api-definition?ref=v1.3.3"
  for_each = var.apis
...
module "transactional_endpoint" {
  source   = "git::https://github.com/akamai/terraform-templates-modules.git//bmp/transactional-endpoint?ref=v1.3.3"
  for_each = var.apis
...
module "security_config_activation" {
  source                          = "git::https://github.com/akamai/terraform-templates-modules.git//bmp/security-config-activation?ref=v1.3.3"
