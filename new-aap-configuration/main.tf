...
module "security" {
  source        = "git::ssh://git@github.com/akamai/terraform-templates-modules.git//aap/security?ref=v1.1.0"
...
module "botman" {
  ...
  source             = "git::ssh://git@github.com/akamai/terraform-templates-modules.git//aap/bot-manager?ref=v1.1.0"
...
module "activate-security" {
  source                          = "git::ssh://git@github.com/akamai/terraform-templates-modules.git//aap/activate-security?ref=v1.1.0"
  config_name                     = var.config_name
  config_id                       = module.security.config_id
