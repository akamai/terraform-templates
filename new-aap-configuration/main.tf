...
module "client-lists" {
  ...
  source              = "git::ssh://git@github.com/akamai/terraform-templates-modules.git//aap/client-lists?ref=v1.3.1"
...
module "security" {
  source        = "git::ssh://git@github.com/akamai/terraform-templates-modules.git//aap/security?ref=v1.3.1"
...
module "botman" {
  ...
  source             = "git::ssh://git@github.com/akamai/terraform-templates-modules.git//aap/bot-manager?ref=v1.3.1"
...
module "activate-security" {
  source                          = "git::ssh://git@github.com/akamai/terraform-templates-modules.git//aap/activate-security?ref=v1.3.1"
  config_name                     = var.config_name
  config_id                       = module.security.config_id
